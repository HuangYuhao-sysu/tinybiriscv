...
specparam tckl = 0.190;
specparam tckh = 0.178;
specparam tcyc = 0.773;

specparam tas = 0.096;
specparam tah = 0.057;
specparam tds = 0.103;
specparam tdh = 0.057;
specparam tcebs = 0.190;
specparam tcebh = 0.054;
specparam twebs = 0.104;
specparam twebh = 0.043;
specparam tbwebs = 0.110;
specparam tbwebh = 0.034;
