...
specparam tckl = 0.488;
specparam tckh = 0.440;
specparam tcyc = 1.982;

specparam tas = 0.249;
specparam tah = 0.105;
specparam tds = 0.274;
specparam tdh = 0.105;
specparam tcebs = 0.488;
specparam tcebh = 0.112;
specparam twebs = 0.266;
specparam twebh = 0.074;
specparam tbwebs = 0.291;
specparam tbwebh = 0.040;
