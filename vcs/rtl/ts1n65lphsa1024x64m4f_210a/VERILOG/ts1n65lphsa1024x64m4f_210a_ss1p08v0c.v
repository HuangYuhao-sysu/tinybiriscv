...
specparam tckl = 0.473;
specparam tckh = 0.417;
specparam tcyc = 1.888;

specparam tas = 0.231;
specparam tah = 0.100;
specparam tds = 0.228;
specparam tdh = 0.100;
specparam tcebs = 0.473;
specparam tcebh = 0.105;
specparam twebs = 0.258;
specparam twebh = 0.071;
specparam tbwebs = 0.242;
specparam tbwebh = 0.065;
